...
Preproccessing is a way to write CSS in a new language.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

My favorite concept in preprocessing is nesting. Instead of using specificity for each element I can just nest the child element inside the parent and manipulate the element there. The concept that gives me the most trouble is parametric mixins. Creating arguments and parameters for a class to manipulate an already existing class is kind of confusing.

3. How would you explain the concept of a variable to someone new to programming?

A variable is a way for use to store data for later use.

4. What is the purpose of using functions in code?

Functions allow you to reuse code repeatedly.

5. What is a JSON data?

JSON data is variables is key:value pairs that are converted into text for the server to read the data. 
